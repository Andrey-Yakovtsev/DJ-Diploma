# Generated by Django 3.1 on 2020-10-05 05:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, upload_to='media/articles/%Y/%m/%d')),
                ('related_product', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='shop.product')),
            ],
            options={
                'verbose_name': 'Статья',
